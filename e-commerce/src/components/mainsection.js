...
function Mainsection() {
  return (
    <div className="p-4 flex flex-col w-full">
      ...
      <div className="h-auto text-2xl font-semibold py-5 text-gray-800">
        Popular Categories
      </div>
      <div className="flex flex-row">
        ...
        <Minicard
          ...
          d2="M8 14a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"
        />
        <Minicard
          xmlns="http://www.w3.org/2000/svg"
          width="30"
          ...
          d2="M8 11a2.5 2.5 0 1 1 0-5 2.5 2.5 0 0 1 0 5zm0 1a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7zM3 6.5a.5.5 0 1 1-1 0 .5.5 0 0 1 1 0z"
        />
        <Minicard
          xmlns="http://www.w3.org/2000/svg"
          width="30"
        ...
        <Minicard
          ...
          d2="M5.667 16C4.747 16 4 15.254 4 14.333v-1.86A5.985 5.985 0 0 1 2 8c0-1.777.772-3.374 2-4.472V1.667C4 .747 4.746 0 5.667 0h4.666C11.253 0 12 .746 12 1.667v1.86a5.99 5.99 0 0 1 1.918 3.48.502.502 0 0 1 .582.493v1a.5.5 0 0 1-.582.493A5.99 5.99 0 0 1 12 12.473v1.86c0 .92-.746 1.667-1.667 1.667H5.667zM13 8A5 5 0 1 0 3 8a5 5 0 0 0 10 0z"
        />
        <Minicard
          xmlns="http://www.w3.org/2000/svg"
          width="30"
